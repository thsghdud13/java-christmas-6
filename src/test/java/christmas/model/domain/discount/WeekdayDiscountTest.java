...
class WeekdayDiscountTest {
    ...
    @ParameterizedTest
    @CsvSource(value = {"2023,12,7,2,4046", "2023,12,3,1,2023", "2023,12,8,2,0", "2023,10,8,23,0", "2024,1,1,30,0"})
    public void 평일_할인_테스트(int year, int month, int dayOfMonth, int dessertCount, int result) {
        ...
        //when
        Discount discount = weekdayDiscount.getDiscountAmount(reservation);
